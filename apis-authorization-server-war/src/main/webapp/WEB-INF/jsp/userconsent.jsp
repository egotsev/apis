	...
	<div class="main">
		<div class="full">
			...
			<div class="page-header">
				<h1>
					<strong>${client.name}</strong> wants to retrieve data from <strong>${client.resourceServer.name}</strong>
				</h1>
			</div>
			...
			<form id="accept" method="post"
				action="${pageContext.request.contextPath}${actionUri}">
				...
				<fieldset>
					<div class="form-actions">
						<button id="user_oauth_approval" name="user_oauth_approval"
							value="true" type="submit" class="btn btn-success">Grant
							permission</button>
						&nbsp;&nbsp;&nbsp;<em>or</em>&nbsp;&nbsp;&nbsp;

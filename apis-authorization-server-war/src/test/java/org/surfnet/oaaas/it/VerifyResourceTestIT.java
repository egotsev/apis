...
public class VerifyResourceTestIT extends AbstractAuthorizationServerTest {
	...
	public void withNoParams() {
		final ClientResponse response = client.resource(
				baseUrlWith("/v1/tokeninfo")).get(ClientResponse.class);
	...
	public void happy() throws IOException {
		...
		final VerifyTokenResponse verifyTokenResponse = objectMapper.readValue(
				json, VerifyTokenResponse.class);
		assertEquals("it-test-enduser", verifyTokenResponse.getPrincipal()
				.getName());
	}
}

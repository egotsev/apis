...
public abstract class AbstractFilter implements Filter {
	...
	/**
	 * The constant used to keep 'session' state when we give flow control to
	 * the authenticator filter. Part of the contract with the authenticator
	 * Filter is that we expect to get the value back when authentication is
	 * done.
	 */
	...
	protected final void setAuthStateValue(ServletRequest request,
			String authState) {

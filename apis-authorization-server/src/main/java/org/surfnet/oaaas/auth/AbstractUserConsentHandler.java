...
public abstract class AbstractUserConsentHandler extends AbstractFilter {
	...
	/**
	 * The constant that contains the scopes, set by concrete
	 * userConsentHandlers and consumed by the authorization endpoint.
	 */
	 ...
	 * to step out and return to the current location</li>
	 * <li>use {@link #getClient(javax.servlet.ServletRequest)} for accessing
	 * the {@link Client} data</li>
	 * </ul>
	 * <p>
	...
	/**
	 * Set the granted scopes of the consent on the request. Note: this
	 * optional.
	 * 
	 * @param request
	 ...
	 */
	protected final void setGrantedScopes(ServletRequest request,
			String[] scopes) {

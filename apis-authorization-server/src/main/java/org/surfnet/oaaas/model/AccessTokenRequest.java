...
public class AccessTokenRequest {
	...
	public static AccessTokenRequest fromMultiValuedFormParameters(
		...
		atr.setClientSecret(nullSafeGetFormParameter("client_secret",
				formParameters));
		...
		atr.setRedirectUri(nullSafeGetFormParameter("redirect_uri",
				formParameters));
		atr.setRefreshToken(nullSafeGetFormParameter("refresh_token",
				formParameters));
		atr.setScope(nullSafeGetFormParameter("scope", formParameters));
		return atr;
	}

	private static String nullSafeGetFormParameter(String parameterName,
			MultivaluedMap<String, String> formParameters) {

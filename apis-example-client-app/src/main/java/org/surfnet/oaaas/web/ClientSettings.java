...
public class ClientSettings {
	...
	public ClientSettings(String accessTokenEndPoint, String oauthKey,
			String oauthSecret, String authorizationURL, String step,
			String requestURL) {
		super();
	...
	/**
	 * @param authorizationURLComplete
	 *            the authorizationURLComplete to set
	 */
